...
srun singularity exec --bind $WORK --nv cuda10_container.sif $python_path -u eval_linear.py \
--data_path $DATASET_PATH \
--pretrained /mnt/qb/work/berens/smueller93/swav/experiments/cifar10_500ep_bs512_pretrain/checkpoints/ckp-499.pth \
--dist_url $dist_url \
